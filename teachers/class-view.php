                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">The following is the list of items you created for this class</p>
                                    </div>
                                    <div class="content table-responsive table-full-width">
                                        ...
                                        <a href="create-item-view.php?cid=<?php echo $class['cid'] ?>" class="btn btn-info btn-fill pull-right">Create New Item</a>
