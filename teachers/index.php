								...
								<div class="text-center">
									<div class="container p-3">
										...
										<form action="api/login.php" method="post" class="m-5">
											...
											<button class="btn btn-shadow btn-lg" type="submit" ng-click="postData()">Sign In</button>
										</form>

										<div id="form-info">
											<p>
												<a href="../teachers/reset-password.html">Forgot Password?</a>
											</p>
											<p>
										...
										<form class="p-4" action="api/register.php" method="post">
											<div class="form-row justify-content-center align-items-center">
												<div class="form-group input-group col-md-10">
													...
													placeholder="Fullame" minlength="5" aria-label="firstName" required>
												</div>
											</div>
											<div class="form-group form-row justify-content-center align-items-center">
